...
/**
 * Downloads the LumiXPosed module
 *
 * https://github.com/C0C0B01/LumiXposed
 */
@Stable
class DownloadVendettaStep(
    ...
    override val url: String = "https://github.com/C0C0B01/LumiXposed/releases/latest/download/app-release.apk"
